...
(function () {
    ...
    amGloble.page.service_checklist = new $.am.Page({
        ...
        getCheckList: function (userVehicles) {
            ...
            for (var i = 0; i < userVehicles.length; i++) {
                ...
                if (vehicle.model) {
                    ...
                    var url = amGloble.setting.lang.cdn + "/Mobile-App/akamai/app/checklist/" + amGloble.setting.market.code + "/" + model + "/" + amGloble.setting.lang.code + "/rules.json";
                    $.ajax(url, {
                        dataType: "json",
                        ...
                        success: function (data) {
                            ...
                            checkListData[ajaxObj.index] = {
                                userName: amGloble.userinfo.username,
                                vehicleData: userVehicles[ajaxObj.index],
                                ruleData: ruleData,
                            ...
                            if (processCount == userVehicles.length - 1) {
                                ...
                                if (checkListData.length > 0) {
                                    ...
                                    $.am.changePage(amGloble.page[self.showCheckList], "", "init");
                                }
                            }
                        },
                        error: function (ret) {
            ...
            $.each(checklistData, function (index, val) {
                ...
                amGloble.page[pageId] = new $.am.Page({
                    ...
                    init: function () {
                        ...
                        this.$.find("span.id_link1").vclick(function() {
                                                                                          emap.inAppBrowser({
                                                                                                            url : "https://pms.fordind.com/"
                                                                                                            });
                                                                                          });
                    },
                    //before page show
