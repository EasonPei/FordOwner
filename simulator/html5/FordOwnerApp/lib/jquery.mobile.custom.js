        ...
        $.widget("mobile.slider", $.mobile.widget, $.extend({
            ...
            _create: function () {
                ...
                var self = this,
                    ...
                    valuebg = this.options.highlight && !this.isToggleSwitch ? (function () {
                        //customization
                        var sections = "<div class='ui-slider-sections'><div class='ui-slider-section1'></div><div class='ui-slider-section2'></div><div class='ui-slider-section3'></div><div>";
                        slider.prepend(sections);
            ...
            refresh: function (val, isfromControl, preventInputUpdate) {
                ...
                if (this.valuebg) {
                    ...
                    this.valuebg.css("width", 100 - percent + "%");
                }
