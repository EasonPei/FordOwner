...
i18n = {
    ...
    "FIRSTUSE_SELECTREGION_TEXT10": 'User denied the request for Geolocation',
    "FIRSTUSE_SELECTREGION_TEXT11": 'Browser does not support Geolocation!',
    "FIRSTUSE_SELECTREGION_TEXT12": 'The request to get user location timed out.',
    ...
    //FIRSTUSE_LINK
    "FIRSTUSE_LINK_TEXT1": 'Already have a Ford Owners Portal account? Use it to log in.',
    ...
    "CONTACT_ROADSIDEASSISTANCE_TEXT3": 'Have your Vehicle Identification Number (VIN) handy when calling Ford Roadside Assistance. For your convenience, please find your vehicle information below after login:',
    ...
    "SIGNUP_CONTACT_P": 'For access to the Ford Owners Portal site, you must complete the optional section below. Tap SKIP to do it later.',
    ...
    "PROFILE_MYACCOUNT_COMPLETE": 'For full access to Ford Owners Site services, please complete the form below',
    ...
    "PROFILE_UPDATEINFO_ERROR": 'Error message',
   ...
   // "SETTING_MAIN_PRIVACY": 'Privacy Policy',
	...
	// Select language is not available for IN
    ...
    "DEALER_LOCATOR_ACTION_FAV": "My Favorite",
    ...
    "DEALER_SEARCH_ERROR_LOCATION": "Please enter a valid pincode or city.",
    ...
    "DEALER_SEARCH_SOMETHING_WRONG": "Failed to load map resources.<br/>Please try again.",
    "DEALER_SEARCH_NORESULT_SHORT_TEXT": "Can't get your current location.<br/>Please change location;<br/>Or find a better network.",
    "DEALER_SEARCH_NO_NEARBY": "No nearby dealers can be found.<br/>Please try dealer search manually.",
    ...
    "CHECKLIST_NOTE": "Note",
    "CHECKLIST_DISCLAIMERS": "Disclaimers",
    "CHECKLIST_DISCLAIMERS_CONTENT":"Parts cost indicated are based on Delhi MRP<br/>These are indicative prices, please contact dealer for further details<br/>For variants not listed please contact dealer for further details<br/>Consumables & service taxes are extra",
    ...
    //Tao: those two for the list item, they are in the item footer
